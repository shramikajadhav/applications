...
<table border="1" cellpadding="5" cellspacing="5">
            ...
            <c:forEach var="pr" items="${prod}">
                <tr>
                    <td>${pr.prodname}</td>
                    <td>${pr.prodDescription}</td>
                    <td>${pr.prodprice}</td>
                     <td>${pr.sellerquant}</td>
                    <td><img src="resources/${pr.photoName}"></td>
                    
                 
                   <td> <a href="addToCart.htm?prodID=${pr.prodID}&sellerquant=${pr.sellerquant}">Add to Cart</a></td>
