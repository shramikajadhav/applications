...
<div class="row blur">
  ...
  <div class="twelve columns">
    ...
    <div class="row">
      <div class="nine columns" style="margin-bottom: 10px">
        <ul id="menu-header" class="nav-bar horizontal">
        	...
        	<li style="padding : 30px; border : 2px;"><a href="loginuser.htm"><h style= "font-size : 30px; ">Back</h></a></li>
        </ul>
    ...
    <div>
 <h3>HI     Seller  ...... Welcome!!</h3>
 
 
 
 <div style="padding : 30px;">
 <div class="button" style="padding : 80px ;width: 30%; float:left">
  <a href="AddProduct.htm"><h3>Add Product</h3></a>
  
</div>

<div  class="button" style="padding : 80px;width: 30%; float:right">
   <a href="ViewOrder.htm"><h3>View Order</h3></a>
</div>

<div  class="button" style="padding : 80px;width: 30%; float:right">
   <a href="DisplayProduct.htm"><h3>Display Products</h3></a>
</div>
